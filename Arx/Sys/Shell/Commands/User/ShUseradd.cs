...
namespace Arx.Sys.Shell.Commands.User
{
    ...
    {
        public ShUseradd() : base("useradd", "Add new user", Sys.User.UserAccess.Root) { }
        ...
        public override void Execute(string[] args)
        {
            ...
            if(isRoot) { Kernel.UserManager.CreateUser(new Sys.User.User(username, password, Sys.User.UserAccess.Root)); }
            else { Kernel.UserManager.CreateUser(new Sys.User.User(username, password, Sys.User.UserAccess.User)); }
        }
    }
}
